...
import it.dlvsystem.repository.SkillRepository;
...
public class SkillResourceIT {
    ...
    private static final String DEFAULT_CODICE_ESCO = "2";
    private static final String UPDATED_CODICE_ESCO = "5193";
    ...
    public void createSkill() throws Exception {
        ...
        assertThat(testSkill.getCodiceEsco()).isEqualTo(DEFAULT_CODICE_ESCO);
        assertThat(testSkill.getNome()).isEqualTo(DEFAULT_NOME);
        assertThat(testSkill.getTipo()).isEqualTo(DEFAULT_TIPO);
    }
    ...
    public void updateSkill() throws Exception {
        ...
        Skill testSkill = skillList.get(skillList.size() - 1);
        assertThat(testSkill.getCodiceEsco()).isEqualTo(UPDATED_CODICE_ESCO);
        assertThat(testSkill.getNome()).isEqualTo(UPDATED_NOME);
        assertThat(testSkill.getTipo()).isEqualTo(UPDATED_TIPO);
    }
