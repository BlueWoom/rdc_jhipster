...
export class OccupazioneComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.occupazioneService
      ...
      .subscribe(
        (res: HttpResponse<IOccupazione[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInOccupaziones(): void {
    this.eventSubscriber = this.eventManager.subscribe('occupazioneListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IOccupazione[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/occupazione'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
