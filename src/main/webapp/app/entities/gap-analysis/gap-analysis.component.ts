...
export class GapAnalysisComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.gapAnalysisService
      ...
      .subscribe(
        (res: HttpResponse<IGapAnalysis[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGapAnalyses(): void {
    this.eventSubscriber = this.eventManager.subscribe('gapAnalysisListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IGapAnalysis[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
