...
export class SkillUtenteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.skillUtenteService
      ...
      .subscribe(
        (res: HttpResponse<ISkillUtente[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSkillUtentes(): void {
    this.eventSubscriber = this.eventManager.subscribe('skillUtenteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISkillUtente[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/skill-utente'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
