...
export class OffertaSkillComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.offertaSkillService
      ...
      .subscribe(
        (res: HttpResponse<IOffertaSkill[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInOffertaSkills(): void {
    this.eventSubscriber = this.eventManager.subscribe('offertaSkillListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IOffertaSkill[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/offerta-skill'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
