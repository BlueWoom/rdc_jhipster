...
export class CvComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.cvService
      ...
      .subscribe(
        (res: HttpResponse<ICv[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICv[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
