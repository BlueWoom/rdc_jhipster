...
export class NavigatorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.navigatorService
      ...
      .subscribe(
        (res: HttpResponse<INavigator[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInNavigators(): void {
    this.eventSubscriber = this.eventManager.subscribe('navigatorListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: INavigator[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
