...
export class CvIstruzioneComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.cvIstruzioneService
      ...
      .subscribe(
        (res: HttpResponse<ICvIstruzione[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCvIstruziones(): void {
    this.eventSubscriber = this.eventManager.subscribe('cvIstruzioneListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICvIstruzione[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/cv-istruzione'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
