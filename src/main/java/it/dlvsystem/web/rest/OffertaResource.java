...
public class OffertaResource {
     ...
     */
    @GetMapping("/offertas")
    public ResponseEntity<List<Offerta>> getAllOffertas(Pageable pageable) {
        log.debug("REST request to get a page of Offertas");
        Page<Offerta> page = offertaRepository.findAll(pageable);
