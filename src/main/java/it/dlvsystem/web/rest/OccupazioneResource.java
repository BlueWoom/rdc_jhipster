...
public class OccupazioneResource {
    ...
    public List<Occupazione> getAllOccupaziones(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Occupaziones");
        return occupazioneRepository.findAllWithEagerRelationships();
    }
