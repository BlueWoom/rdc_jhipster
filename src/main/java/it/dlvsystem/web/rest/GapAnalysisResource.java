...
public class GapAnalysisResource {
    ...
    public ResponseEntity<List<GapAnalysis>> getAllGapAnalyses(Pageable pageable) {
        log.debug("REST request to get a page of GapAnalyses");
        Page<GapAnalysis> page = gapAnalysisRepository.findAll(pageable);
