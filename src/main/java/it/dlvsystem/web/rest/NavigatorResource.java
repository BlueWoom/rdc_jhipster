...
public class NavigatorResource {
    ...
    public ResponseEntity<List<Navigator>> getAllNavigators(Pageable pageable) {
        log.debug("REST request to get a page of Navigators");
        Page<Navigator> page = navigatorRepository.findAll(pageable);
